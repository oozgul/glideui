...
anchorFrame:SetPoint("CENTER", UIParent, "CENTER", 100, 100)  -- Initially place it at the bottom of the screen
...
frame:SetScript("OnLeave", function()
  ...
  local _, _, _, itemRarityColor = GetItemQualityColor(itemQuality) 
  local r, g, b = ConvertRGBtoDecimal(itemRarityColor)
  ...
  frame:SetBackdropColor(r, g, b, 0.3)
    ...
    text:SetTextColor(r, g, b) -- now the text matches the rarity color
...
eventHandler:SetScript("OnEvent", function(self, event, ...)
    if event == "CHAT_MSG_MONEY" then 
        local message = ...
        if string.find(message, "You loot") then
